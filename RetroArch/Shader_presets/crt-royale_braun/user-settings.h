...
//  GEOMETRY:
    ...
    // default (256/224)*(256/240)*(1/1) = 1.21904761905 (see below)
	// for 256x240 games with 1:1 PAR
    // static const float geom_aspect_ratio_static = 1.21904761905;
	// for 320x240 games with 1:1 PAR
    static const float geom_aspect_ratio_static = 1.904761904761905;
