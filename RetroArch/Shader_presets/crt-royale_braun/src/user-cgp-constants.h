...
//  ProfessorBraun B&W masks (for 1080p displays)
//  IMPORTANT:
...
static const float2 mask_resize_viewport_scale = float2(0.25, 0.25);
//  Copy the geom_max_aspect_ratio used to calculate the MASK_RESIZE scales, etc.:
static const float geom_max_aspect_ratio = 16.0/9.0;
...
static const float2 mask_texture_small_size = float2(48.0, 48.0);
static const float2 mask_texture_large_size = float2(48.0, 48.0);
static const float mask_triads_per_tile = 2.0;
...
static const float mask_grille15_avg_color = 178.5/255.0;
    //  TileableLinearApertureGrille15Wide6d33Spacing*.png
    //  TileableLinearApertureGrille15Wide8And5d5Spacing*.png
static const float mask_slot_avg_color = 114.75/255.0;
...
static const float mask_shadow_avg_color = 153.0/255.0;
