...
//  Analogue Color Knobs
    ...
    vec2 TV_lvl =  (g_crtgamut == 5.0) ? vec2(1.0, 1.0)            : \
                   (g_crtgamut == 4.0) ? vec2(1.0, 1.0)            : \
                                         vec2(1.-0.0627,1.-0.05882);

    col = (g_crtgamut == 5.0) ? clamp(col.xyz, vec3(1.0-TV_lvl.x, -0.4360*TV_lvl.x, -0.6150*TV_lvl.x), vec3(0.92157, 0.4360*TV_lvl.y, 0.6150*TV_lvl.y)) : \
                                clamp(col.xyz, vec3(1.0-TV_lvl.x, -0.5957*TV_lvl.x, -0.5226*TV_lvl.x), vec3(0.92157, 0.5957*TV_lvl.y, 0.5226*TV_lvl.y));
